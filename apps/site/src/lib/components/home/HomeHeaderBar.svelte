<!-- BL: this is the HeaderNavbar -->

<script lang="ts">
	import { page } from '$app/stores';
	import { BellIcon, InstagramIcon, MoonIcon, SunIcon } from 'svelte-feather-icons';
</script>
...
<div class="navbar px-5 border-b border-opacity-10 border-base-content">
	<!-- APP TITLE  -->
	<div class="flex-1">
		<a href="/home" class="link no-underline text-xl"> Home Header </a>
	</div>
